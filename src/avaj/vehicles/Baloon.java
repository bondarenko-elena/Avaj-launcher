...
public class Baloon extends Aircraft implements Flyable {
    ...
    public void updateConditions() {
        ...
        Parser.writer.println( "Baloon#" + this.name + "(" + this.id + "): " + messages.get(
                weather.toUpperCase() ) );
        if ( this.coordinates.getHeight() == 0 ) {
            Parser.writer.println( "Baloon#" + this.name + "(" + this.id + "): landing." );
            this.weatherTower.unregister( this );
            Parser.writer.println( "Tower says: Baloon#" + this.name + "(" + this.id + ")" + " unregistered from weather tower." );
        }
    }
